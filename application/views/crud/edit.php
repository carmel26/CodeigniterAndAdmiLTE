...
<div id="container">
    <div class="card-body">
        ...
        <form method="POST" action="<?= base_url('index.php/Product/editSave/' . $data->id) ?>">
            <div class="row">
                <div class="col-sm-12">
                    <!-- text input -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="type" value="Liquid" <?= ($data->type === 'Liquid') ? 'checked' : '' ?>>
                                <label class="form-check-label">Liquid</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="type" value="Solid" <?= ($data->type === 'Solid') ? 'checked' : '' ?>>
                                <label class="form-check-label">Solid</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="type" value="Gas" <?= ($data->type === 'Gas') ? 'checked' : '' ?>>
